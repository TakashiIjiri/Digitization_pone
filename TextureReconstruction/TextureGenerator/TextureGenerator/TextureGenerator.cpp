...
// TextureGenerator.cpp : アプリケーションのクラス動作を定義します。
//
...
// CTextureGeneratorApp コンストラクション
...
// 唯一の CTextureGeneratorApp オブジェクトです。

CTextureGeneratorApp theApp;


// CTextureGeneratorApp 初期化
...
// CTextureGeneratorApp メッセージ ハンドラー
